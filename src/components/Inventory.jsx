...
=======
    ...
    return (
        ...
        <div className='w-full h-full sm:h-auto  sm:min-h-[90%] sm:max-w-[90%] md:max-w-[70%] lg:max-w-[50%] xl:max-w-[40%] 
    flex flex-col bg-white rounded-lg overflow-hidden overflow-y-auto fixed inset-0 
    mx-auto p-6 shadow-lg sm:top-1/2 sm:left-1/2 sm:-translate-x-1/2 sm:-translate-y-1/2'>
        {/* Content goes here */}
            <div className='flex-2 shrink-0'>
                <div className='text-center font-semibold text-white bg-PeriwinklePurpleDark py-4 px-0 relative'>
        ...
        <i class="fa-solid fa-arrow-left "></i>
                ...
                <div className='flex p-2 px-4 gap-x-5 overflow-x-auto font-semibold max-[490px]:gap-x-2'>
                    {inventory.map((item, i) => {
                        return <p key={i} className={`text-black border-PeriwinklePurpleDark border px-4 py-1 rounded-full cursor-pointer ${item.active ? "activeDropdown" : ""} shrink-0`} onClick={(e) => { activeItem(i, e) }}>{item.mainItem}</p>
                    })}
            ...
            <div className='flex justify-between px-8 py-4 bg-PeriwinklePurpleDark items-center fixed w-full bottom-0 left-0 z-50'>
