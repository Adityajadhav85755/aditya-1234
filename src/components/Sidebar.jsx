...
export default function Sidebar({ LoginStatusContext, setShowLoginForm }) {
    ...
    const [isDropdownOpen, setIsDropdownOpen] = useState(false); // For toggling the dropdown visibility

    // Toggle dropdown visibility
    const toggleDropdown = (id) => {
        setIsDropdownOpen((prevState) => (prevState === id ? null : id)); // Toggle dropdown based on ID
    };
    ...
    return (
        <>
            {/* Navbar for mobile */}
            <nav className="fixed top-0 left-0 w-full bg-primary text-white flex items-center justify-between px-4 py-3 md:hidden z-50">
                {/* Logo */}
                <div className="flex items-center">
                    <Link to="/" className="flex items-center">
                        <img src={logo} alt="Logo" className="w-10 h-auto" />
                        <p className="font-bold text-lg ml-3">Sky Packers & Movers</p>
                    </Link>
                </div>
            ...
            >
                ...
                <ul className="mt-20 flex flex-col gap-4">
                    ...
                    <li className="relative group">
                        <div
                            onClick={() => toggleDropdown('services')} // Toggle the dropdown for services
                            className="block px-4 py-2 tracking-wider border-2 border-transparent hover:border-white hover:bg-gray-700 hover:rounded-lg hover:shadow-lg transition-all cursor-pointer flex justify-between items-center"
                        >
                            Services
                            <i
                                id="icon-services"
...
//                 <div className='logoContainer h-[90%] w-[90%] z-1 bg-PeriwinklePurpleDark absolute left-0 top-0'>
...
//     {/* Video Section */}
//     <div className="bg-PeriwinklePurpleLight
//     p-4 sm:p-3 md:p-6 lg:p-8 
//     rounded-md 
//     mb-6 sm:mb-4 md:mb-5 lg:mb-8 
//     m-4 
...
//   style={{
//     backgroundImage: `url(/img/House.png)`,
...
//   style={{
//     backgroundImage: `url(/img/newcar.png)`,
//     backgroundPosition: 'center',
//   }}
// ></div>
//       </Link>
...
//   className="h-14 w-14 rounded-full bg-cover"
//   style={{
//     backgroundImage: `url(/img/ac_install.png)`,
//     backgroundPosition: 'center',
//   }}
// ></div>
//       </Link>
...
//   className="h-14 w-14 rounded-full bg-cover"
//   style={{
//     backgroundImage: `url(/img/newwarehouse.png)`,
//     backgroundPosition: 'center',
//   }}
// ></div>
//       </Link>
...
//   className="h-14 w-14 rounded-full bg-cover"
//   style={{
//     backgroundImage: `url(/img/rentalac.png)`,
//     backgroundPosition: 'center',
//   }}
// ></div>
//       </Link>
...
//   className="h-14 w-14 rounded-full bg-cover"
//   style={{
//     backgroundImage: `url(/img/shop.png)`,
//     backgroundPosition: 'center',
//   }}
// ></div>
//       </Link>
...
//   className="h-14 w-14 rounded-full bg-cover"
//   style={{
//     backgroundImage: `url(/img/newamc.png)`,
//     backgroundPosition: 'center',
//   }}
// ></div>
//       </Link>
